...
public class EnemyController : MonoBehaviour
{
    ...
    public bool useGravity;             // 重力に縛られる科か空を飛ぶかのフラグ
    ...
    void Update()
    {
        ...
        // 移動実行
        Vector3 glovalDirection = transform.TransformDirection(moveDirection);
        controller.Move(glovalDirection * Time.deltaTime);
