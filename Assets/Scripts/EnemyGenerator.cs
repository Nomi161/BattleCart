...
public class NewMonoBehaviourScript : MonoBehaviour
{
    ...
    public float minIntervalTime = 0.1f;    // インターバルの最小値
    public float maxIntervalTime = 1.0f;    // インターバルの最大値
    ...
    private void FixedUpdate()
    {
        ...
        transform.position = Vector3.Lerp(
            transform.position,
            cam.transform.position + diff,  // カメラに近づく方向に加算
    ...
    void DangerCreated()
    {
        ...
        // いったん生成位置情報のvの高さはEnemyGeneratorと同じ位置
